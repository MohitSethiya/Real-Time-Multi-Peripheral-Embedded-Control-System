...
#define SYSCTL_RCGCWD           0x400FE600  // Watchdog
...
#define SYSCTL_RCGCADC          0x400FE638  // ADC Run Mode Clock Gating Control
#define SYSCTL_RCGCI2C          0x400FE620  // I2C Run Mode Clock Gating Control
...
#define RSC_BASE                0x400FE000
#define RSC_OFFSET              0x0000005C

#define WATCHDOG_LOAD           0x40000000
#define WATCHDOG_CTL            0x00000008
#define WATCHDOG_LOCK           0x00000C00
#define WATCHDOG_RCGCWD         0x00000600
#define WATCHDOG_PRWD           0x400FEA00
...
#define ADC_O_PSSI              0x00000028  // ADC Processor Sample Sequencer Initiate
